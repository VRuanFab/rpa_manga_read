...
class Capitulos:
    ...
    def listaCapitulos(self):
        ...
        pegando_capitulo = self.driver.procurarElementoVisivel('XPATH', f"//*/h4[text()='Chapter {self.capitulo}']/..")
        pegando_capitulo.click()
        
        escolhendo_idioma = self.driver.procurarElementoVisivel('XPATH', f"//*/h4[text()='Chapter {self.capitulo}']/../../../../../../../../..//*/img[@title='Portuguese (Br)']/../..")
